...
The league entities respond to clicks and call the Season Badge API with the league ID to display a season badge image (can be for any season you like or the first entity in the Home Assignment - FE - Sports Leagues response).

Responses should be cached to avoid repeat callstrDescriptionEN
